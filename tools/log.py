...
class Logger(object):
    def __init__(self,log_name,log_level,log_file):
        ...
        self.fh = logging.handlers.RotatingFileHandler(self.log_file,maxBytes=8388608888, backupCount=5, encoding='utf-8')
    ...
    def log_init(self):
        ...
        fileHandler = logging.handlers.RotatingFileHandler(self.log_file,maxBytes=8388608888, backupCount=5, encoding='utf-8')
